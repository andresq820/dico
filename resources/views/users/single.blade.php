                ...
                <div class="col-sm-4">
                   ...
                   <footer>
                        ...
                        <div class="personal_info">
                            <p>
                            <i class="glyphicon glyphicon-envelope"></i>email@example.com <a href="#"> edit</a>
                            <br />
                            <i class="fa fa-dashboard"></i>Role: Admin <a href="#"> edit</a>
                            <br>
                            <i class="fa fa-users"></i><author>Manager: Lina Escarria</author> <a href="#"> edit</a>
                            <br />
